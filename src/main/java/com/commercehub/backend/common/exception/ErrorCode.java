...
public enum ErrorCode {
    ...
    AVATAR_IMAGE_INVALID_DIMENSIONS(400, "Ảnh đại diện sau xử lý phải có kích thước 512 x 512 px!", HttpStatus.BAD_REQUEST),
    IMAGE_UPLOAD_METADATA_NOT_ALLOWED(400, "Ảnh tải lên không được chứa EXIF/XMP hoặc dữ liệu ảnh động!", HttpStatus.BAD_REQUEST),
